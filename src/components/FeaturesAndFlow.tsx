    ...
    <section className="py-16 px-4 sm:px-8 bg-white" id="features">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-slate-50/80 border border-slate-200/80 rounded-3xl p-6 sm:p-8 shadow-sm hover:shadow-md transition-all flex flex-col justify-between">
            <div>
          ...
          <div className="bg-slate-50/80 border border-slate-200/80 rounded-3xl p-6 sm:p-8 shadow-sm hover:shadow-md transition-all flex flex-col justify-between" id="how-it-works">
            <div>
              <div className="flex items-center gap-3 pb-4 mb-6 border-b border-slate-200">
